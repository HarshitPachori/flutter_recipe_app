          ...
          children: [
            Padding(
              ...
              child: Column(
                ...
                children: [
                  buildTextTitleVariation1("Veg Recipes"),
                  ...
                  Row(
                    ...
                    children: [
                      option(
                          'Vegetable',
                          "https://image.flaticon.com/icons/png/128/2329/2329903.png",
                          0),
                      SizedBox(
                        width: 8,
                      ),
                      option(
                          'Rice',
                          "https://image.flaticon.com/icons/png/512/193/193883.png",
                          1),
                      SizedBox(
                        width: 8,
                      ),
                      option(
                          'Fruits',
                          "https://cdn.iconscout.com/icon/premium/png-256-thumb/fruit-1655958-1406415.png",
                          2),
                    ],
                  )
                ],
            ...
            Padding(
              ...
              child: Row(
                children: [
                  buildTextTitleVariation("Popular", false),
                  SizedBox(
                    width: 8,
                  ),
                  buildTextTitleVariation("Food", true),
                ],
              ),
            ),
            Container(
...
//
  List<Widget> buildRecipes() {
    ...
    for (var i = 0; i < getRecipe().length; i++) {
      list.add(buildRecipe(getRecipe()[i], i));
    }
    return list;
  }
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        margin: EdgeInsets.only(
            right: 16, left: index == 0 ? 16 : 0, bottom: 14, top: 0),
                ...
                child: Container(
                  decoration: BoxDecoration(
                    image: DecorationImage(
                        image: NetworkImage(recipe.image), fit: BoxFit.contain),
                  ),
                ),
              ),
            ),
      ...
      child: Row(
        children: [
          Container(
            ...
            decoration: BoxDecoration(
              image: DecorationImage(
                  image: NetworkImage(recipe.image), fit: BoxFit.fitHeight),
            ),
          ),
          Expanded(
            child: Padding(
